...
public interface RequestDao extends JpaRepository<Request, Integer> {
	...
	@Query("select r from Request r where status=:s and imageuploadstatus=:e")
	public List<Request> viewAllPendingRequest(@Param("s") boolean status , @Param("e") boolean imageuploadstatus);
