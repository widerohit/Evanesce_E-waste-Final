...
public class RequestServiceImple implements RequestService {
	...
	@Override
	public List<Request> viewAllPendingRequests(boolean status , boolean imageuploadstatus) {
		return requestDao.viewAllPendingRequest(false , true);
	}
	...
	public List<Request> findAgentRequests(Agent agent) {
		System.out.println(requestDao.findByAgentid(agent));
