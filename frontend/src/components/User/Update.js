...
const Update = () => {
  ...
  const validate = () => {
    ...
    } else if (parseInt(uquantity) < 0 || parseInt(uquantity) > 100) {
  ...
  return (
    <div>
      <h3 class="text-center text-dark display-8 fw-bold ">Update Request</h3>
      <form class="row g-3 w-50 m-auto p-5 fs-5 log">
        <div className="col-md-12 ">
          <label for="name" className="form-label fs-4">
            Request Id :-
          </label>
          <span className="fs-3 fw-bold text-grey"></span>
          <input
        ...
        <div className="col-md-6 text-center mt-5 mb-5  ">
          <Link to="/view" className="btn btn-primary btn-md ps-5 pe-5 p-3">
            Back
          </Link>
        </div>
        <div className="col-md-6 text-center mt-5 mb-5  ">
